/*
	...
	g++ -O0 -std=c++0x -o FFT FFT_simd.cpp -lrt -msse3

	simd code from Implementation and Evaluation of Parallel FFT Using SIMD Instructions on Multi-Core Processors by Daisuke Takahashi 
